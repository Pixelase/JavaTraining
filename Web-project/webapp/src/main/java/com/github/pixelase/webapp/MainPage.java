...
public class MainPage {
	...
	public static void main(String[] args) {
		...
		// Tenant save = tenantService.save(new Tenant("23sdfs", "Bzevich",
		// null));
		// Tenant save1 = tenantService.save(new Tenant("23sdfs", "Bzevich",
		// null));
		// Tenant save2 = tenantService.save(new Tenant("23sdfs", "Bzevich",
		// null));
