...
import com.github.pixelase.dataaccess.dao.common.FilterProperty;
...
//		tenantService.deleteAll(new Filter(new FilterProperty("last_name", "Bzevich")));
		System.out.println(tenantService.deleteAll(new Filter(new FilterProperty("last_name", "Bzevich"))));
