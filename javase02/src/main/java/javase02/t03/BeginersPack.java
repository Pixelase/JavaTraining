...
public class BeginersPack {
	public static List<Item> generateItems(int maxItemsPrice) {
		...
		items.add(new Penñil("HardPencil", "Pencils corp", rand.nextInt(maxItemsPrice), itemsWeight, "Gray", "Hard"));
		items.add(new Penñil("LightPencil", "Pencils corp", rand.nextInt(maxItemsPrice), itemsWeight, "Gray", "Light"));
